...
#	./go-ethereum/build/bin/geth --identity $HOST_NAME --gasprice "0" --rpc --rpcport "8545" --rpccorsdomain "http://localhost:8545" --datadir "./private_chain" --port "30303" --nodiscover\
...
#	./go-ethereum/build/bin/geth --identity $HOST_NAME --gasprice "0" --rpc --rpcport "8545" --rpccorsdomain "http://localhost:8545" --datadir "./private_chain" --port "30303" --nodiscover\
	./geth --identity $HOST_NAME --gasprice "0" --rpc --rpcport "8545" --rpccorsdomain "http://localhost:8545" --datadir "./private_chain" --port "30303" --nodiscover\
	 --rpcapi "db,eth,net,web3,personal" --fakepow --syncmode "light" --verbosity 5 --minerthreads 1 --networkid 230594 init $PWD"/chain_init_data/genesis_json" 2>>node_error | tee -a node_output
...
#	./go-ethereum/build/bin/geth --identity $HOST_NAME --gasprice "0" --rpc --datadir "./private_chain" --port "30303" --nodiscover\
